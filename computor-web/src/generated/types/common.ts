...
import type { ExampleValidationResult, ExampleVersionGet, ExampleVersionList } from './examples';
...
export interface CourseContentDeploymentGet {
  ...
  example_version?: ExampleVersionGet | null;
}
...
export interface DeploymentHistoryGet {
  ...
  created_by: string | null;
  example_version?: ExampleVersionGet | null;
  previous_example_version?: ExampleVersionGet | null;
}
