...
export interface ExecutionBackend {
  /** Pin a specific runner by Service.slug (e.g. 'itpcp.exec.mat'). Prefer 'language' unless you really need one exact service. */
  slug?: string | null;
  /** Language this example needs (python, octave, r, julia, c, cpp, fortran, document, matlab). Portable across installations. */
  language?: string | null;
  /** Backend/language version requirement, matched against a runner's config.language_version */
  version?: string | null;
 ...
 */
export interface TutorTestResultSummary {
  total?: number | null;
  passed?: number | null;
  failed?: number | null;
  skipped?: number | null;
 ...
 */
export interface TutorTestResultSubmit {
  summary?: TutorTestResultSummary | null;
  total?: number | null;
  passed?: number | null;
  failed?: number | null;
  result_value?: number | null;
...
export interface ServiceCreate {
  ...
  /** Test runner language for testing services (python, octave, r, julia, c, cpp, fortran, document, matlab). Stored into config.language, which is what selects the runner — the slug never does. Required when the service type's category is 'testing'. */
  language?: string | null;
...
export interface CourseContentConfig {
  ...
  example_identifier?: string | null;
  /** Version tag of the example. Semantics: null/missing = first-time assign only (skip if already deployed); 'latest' = always update to the latest available version; '1.2.0' = update only if current version differs */
...
export type ErrorCode = "AUTH_001" | "AUTH_002" | "AUTH_003" | "AUTH_004" | "AUTH_005" | "AUTHZ_001" | "AUTHZ_002" | "AUTHZ_003" | "AUTHZ_004" | "AUTHZ_005" | "AUTHZ_006" | "AUTHZ_010" | "VAL_001" | "VAL_002" | "VAL_003" | "VAL_004" | "NF_001" | "NF_002" | "NF_003" | "NF_004" | "NF_010" | "CONFLICT_001" | "CONFLICT_002" | "RATE_001" | "RATE_002" | "RATE_003" | "CONTENT_001" | "CONTENT_002" | "CONTENT_003" | "CONTENT_004" | "CONTENT_005" | "CONTENT_006" | "CONTENT_007" | "CONTENT_008" | "VERSION_001" | "DEPLOY_001" | "DEPLOY_002" | "DEPLOY_003" | "DEPLOY_004" | "DEPLOY_005" | "SUBMIT_001" | "SUBMIT_002" | "SUBMIT_003" | "SUBMIT_004" | "SUBMIT_005" | "SUBMIT_006" | "SUBMIT_007" | "SUBMIT_008" | "TASK_001" | "TASK_002" | "TASK_003" | "TASK_004" | "GITLAB_001" | "GITLAB_002" | "GITLAB_003" | "GITLAB_004" | "GITLAB_005" | "GITLAB_006" | "GITLAB_007" | "GITLAB_008" | "GIT_001" | "GIT_002" | "EXT_001" | "EXT_002" | "EXT_003" | "EXT_004" | "EXT_005" | "EXT_006" | "DB_001" | "DB_002" | "DB_003" | "INT_001" | "INT_002" | "NIMPL_001";