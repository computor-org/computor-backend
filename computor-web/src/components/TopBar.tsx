      ...
      */}
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-0.5 -right-0.5 min-w-[1.1rem] h-[1.1rem] px-1 flex items-center justify-center text-[0.65rem] font-semibold text-on-accent bg-danger rounded-full">
