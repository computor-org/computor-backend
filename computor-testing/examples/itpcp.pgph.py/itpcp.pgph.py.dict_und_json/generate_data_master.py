...
for sim_name, sim in config.items():
    ...
    res_array = mu + sig * np.random.randn(*size)  # np.random.randn(size[0], size[1])
...
#$META type "standard"
#$META title "Dictionaries und JSON files"
#$META additionalFiles ./data_file.json
#$VARIABLETEST var
#$TESTVAR data["metadata"]
#$TESTVAR data["results"]