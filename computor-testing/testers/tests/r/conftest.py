"""
R Testing Framework - Pytest Configuration

Defines fixtures and hooks for rtester using the object-oriented approach.
"""
...
class RTesterConfig(SimpleTesterConfig):
    """Configuration for R tester."""
    language = "r"
    has_metadata = True
