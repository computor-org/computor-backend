"""
Fortran Testing Framework - Pytest Configuration

Defines fixtures and hooks for ftester using the object-oriented approach.
"""
...
class FortranTesterConfig(SimpleTesterConfig):
    """Configuration for Fortran tester."""
    language = "fortran"
    has_property_inheritance = True


# Create and register all hooks from the config class
_config = FortranTesterConfig()
