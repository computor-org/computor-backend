...
class StudentsClient(RoleBasedViewClient):
    ...
    async def get_student_course_content_by_course_content_id(self, course_content_id: str) -> CourseContentStudentGet:
    ...
    async def get_student_cours_by_course_id(self, course_id: str) -> CourseStudentGet:
