...
class MessagesClient(BaseEndpointClient):
    ...
    async def delete(self, id: str):
        ...
        return await self.delete_message_by_id_read(id)

    async def post_messages(self, payload: MessageCreate) -> MessageGet:
        """Create Message"""
    ...
    async def get_message_by_id(self, id: str) -> MessageGet:
        """Get Message"""
    ...
    async def patch_message_by_id(self, id: str, payload: MessageUpdate) -> MessageGet:
        """Update Message"""
        json_data = payload.model_dump(mode="json", exclude_unset=True) if hasattr(payload, "model_dump") else payload
    ...
    async def delete_message_by_id(self, id: str) -> Any:
        """Delete Message"""
        data = await self._request("DELETE", f"/{id}")

    async def post_message_by_id_read(self, id: str) -> Any:
        """Mark Message Read"""
        data = await self._request("POST", f"/{id}/reads")

    async def delete_message_by_id_read(self, id: str) -> Any:
        """Mark Message Unread"""
