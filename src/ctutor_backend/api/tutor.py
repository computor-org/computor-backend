...
def tutor_get_course_contents_endpoint(
    ...
    return get_tutor_course_content(course_member_id, course_content_id, permissions, db)
...
def tutor_list_course_contents_endpoint(
    ...
    return list_tutor_course_contents(course_member_id, permissions, params, db)
...
async def tutor_get_courses_endpoint(
    course_id: UUID | str,
    permissions: Annotated[Principal, Depends(get_current_principal)],
    db: Session = Depends(get_db)
):
    """Get a course for tutors."""
    return get_tutor_course(course_id, permissions, db)
...
def tutor_list_courses_endpoint(
    ...
    return list_tutor_courses(permissions, params, db)
...
def tutor_get_course_members_endpoint(
    ...
    return get_tutor_course_member(course_member_id, permissions, db)
...
def tutor_list_course_members_endpoint(
    ...
    return list_tutor_course_members(permissions, params, db)
