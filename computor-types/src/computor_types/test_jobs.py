"""Test *job dispatch* DTOs (queue payload + create request).

One of three similarly-named test modules — keep them distinct:
  * ``test_jobs``      — job dispatch (this module: TestJob, TestCreate)
